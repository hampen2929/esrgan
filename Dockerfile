...
RUN chown ubuntu:ubuntu /opt/conda/share/jupyter/nbextensions/ -R
RUN chown ubuntu:ubuntu /opt/conda/share/jupyter/ -R
RUN chown ubuntu:ubuntu /opt/conda/etc/jupyter/ -R
